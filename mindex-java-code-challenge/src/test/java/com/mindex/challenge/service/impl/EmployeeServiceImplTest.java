...
public class EmployeeServiceImplTest {
    ...
    public void testReportingStructure() {
    	...
    	ReportingStructure readReportingStructure = restTemplate.getForEntity(reportStructureUrl, ReportingStructure.class, "16a596ae-edd3-4847-99fe-c4518e82c86f").getBody();
